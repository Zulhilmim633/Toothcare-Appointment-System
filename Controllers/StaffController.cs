...
namespace Toothcare_Appointment_System.Controllers
{
    ...
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(staff); // Returns the list view of students
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return View(staff); // Returns the details view of a student
        }
        ...
        {
            return View(); // Returns the create view of a student
        }
        ...
        public async Task<IActionResult> Create(Staff staff)
        {
            ...
            return View(staff); // Returns the create view of a student
        }
